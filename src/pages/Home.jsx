  ...
  return (
    ...
    <section id="testimonial">
        <div className="testimonial-section">
            ...
            <div className="description">What our clients says</div>
            <div className="swiper testimonial-slider">
                <div className="swiper-wrapper">
                    <div className="swiper-slide">
                        <div className="testimonial-card">   
                            <div className="profile">
                                <img src="/14.jpg" alt="icon"/>
                                <div className="name">Cameron Williamson <br/><span>CEO, ISHKON</span></div>
                            </div>             
                            ...
                            <div className="comment">                                
                                <p>Working with Pentos is a fantastic experience. He trulyunderstood our vision and turned our dream home into a reality. The attention to detail and dedication were beyond my imagniation.</p>                                
                            </div>
    ...
    <section id="blogs">
        <div className="blogs-section">
            ...
            <div className="swiper-action-buttons">         
                <div className="left swiper-button-prev"><img src="/left.png" alt="left-icon"/></div>     
                <div className="right swiper-button-next "><img src="/right.png" alt="right-icon"/></div>                                                                                                           
                ...
                <div className="swiper-wrapper">
                    <div className="swiper-slide">
                        <div className="blog-card">
                            <a href="./pages/blog-single.html" className="center-btn">
                    ...
                    <div className="swiper-slide">
                        <div className="blog-card">
                            ...
                            <img src="/assets/blog/truck.jpg" alt="icon"/>
                        </div>
                    </div>
                    <div className="swiper-slide">
                        <div className="blog-card">
            ...
            <a href="./pages/blog.html">
                <button className="btn-1">View All <img src="/top-right.png" alt="icon"/></button>
            </a>
        </div>
    </section>
